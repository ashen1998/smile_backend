...
public class UserController {
    ...
    public ResponseEntity<?> editRole(@AuthenticationPrincipal UserPrincipal userPrincipal, @PathVariable Role role){

        log.info("UserController : changeRole | Role {}", role );

        userService.editRole(role, userPrincipal.getUsername());
